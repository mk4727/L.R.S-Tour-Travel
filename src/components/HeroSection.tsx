...
import { CarSVG } from "./CarAnimation";
...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Animated car driving across bottom of hero */}
      <div className="absolute bottom-20 left-0 right-0 z-10 opacity-25 pointer-events-none">
        <div className="animate-car-drive">
          <CarSVG className="w-[130px] h-[46px]" />
        </div>
      </div>
        ...
        <div className="max-w-2xl space-y-8">
          <div key={current} className="space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                to="/book"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-lg bg-primary text-primary-foreground font-semibold hover:brightness-110 transition-all glow-emerald"
              >
